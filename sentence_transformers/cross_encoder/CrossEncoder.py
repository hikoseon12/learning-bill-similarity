...
class CrossEncoder():
        ...
        for epoch in trange(epochs, desc="Epoch"):
            ...
            for features, labels in tqdm(train_dataloader, desc="Iteration", smoothing=0.05):
                ...
                if evaluator is not None and evaluation_steps > 0 and training_steps % evaluation_steps == 0:
                    self._eval_during_training(evaluator, output_path, save_best_model, epoch, loss_value, training_steps, callback)
            ...
            if evaluator is not None:
                self._eval_during_training(evaluator, output_path, save_best_model, epoch, avg_loss, -1, callback)
    ...
    def _eval_during_training(self, evaluator, output_path, save_best_model, epoch, loss, steps, callback):
